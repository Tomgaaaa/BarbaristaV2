...
// script qui permet de stocker tout les enum du jeu, pas de fonctions a mettre


public enum enumAllIgredient { Scolk, Frejal, Shembo, Phylliul, Siarym, Klec } // enum de tout les ingrédients, utile pour l'ettagere
